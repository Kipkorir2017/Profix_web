...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#0F172A] shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-white">
            APEX
            <span className="text-orange-500">MARK</span>
          </h1>
        </div>
        ...
        <ul className="hidden md:flex items-center gap-8">
          ...
          <li>
            <NavLink to="/spare-parts" className={linkClass}>
              Spare Parts
            </NavLink>
          </li>
        ...
        <div className="hidden md:block">
          <Link to="/contact">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg font-semibold transition duration-300">
              Get Quote
            </button>
          </Link>
        </div>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-[#0F172A] px-6 pb-6">
          <div className="flex flex-col items-end gap-5">
            ...
            <Link to="/contact" onClick={() => setMenuOpen(false)}>
              <button className="mt-2 bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg font-semibold transition duration-300">
                Get Quote
              </button>
            </Link>
          </div>
